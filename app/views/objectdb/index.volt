...
<script type="text/javascript" src="https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js?lang=sql"></script>
    ...
    <div class="row">
        ...
        <span>
            ...
            <br>
                 <li>
                      Cмысл заключается вот в чём: - Если обвернуть запрос во "View" и обращаться к запросу, как к обычной таблице, то мы можем получить очень неплохие вкусняхи,
                            к примеру, можно использовать расширения, и в полной мере использовать возможности PostgreSql ltree, dblink, postgres_fdw, file_fdw, Windows function, join lateral, pivot extension etc".
                 </li>
            <br>
            <p>
