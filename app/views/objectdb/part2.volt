    ...
    <ul>
        <li>
            <p>Для начала нужно понять, как планировщик выполнения запросов PostgreSQL, в зависимости от конструкции,
                ...
                Хотя статья по работе с планировщиком штука не очень простая и заслуживает более детального описания,
...
<tr><td>Execution time: 0.092 ms</td></tr>
    ...
    <tr><td>Execution time: 0.157 ms</td></tr>
        ...
        <li>Cамое интересное выгребем с условием но при этом возьмём только одно поле.
        ...
        <li>
            В не зависимости от количества не обязательных джойнов и обращений,
            планировщик будет терзучить только то множество, которое будет в результате,
            а подсчёт строк будет игнорировать связи, которых нет в результате, если связывание не обязательное (join).
