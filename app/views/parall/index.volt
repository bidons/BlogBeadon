...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <span>Параллельные координаты - способ визуализации статистических данных  в виде паралельных координат</span>
        <br>
        </li>
            В анализе учавствуют 140000-тысч слов частей речи и форм образований. Книга "Библия" 38546 старниц, определённых слов 511163, всего 593991
        </li>
            <br>
            <li>
                Управление:
                <p>
                Приблизить -  выделить фрагменту в одном из измерений X нажать приблизить
                </p>
                <p>
                Исключить- выделить фрагмент в одном из измерений X нажать исключить
                </p>
                <p>
                Export - експортировать выбраное множество учитывая выбранные координаты (X,Y, или поиск по именам)
                </p>
                <p>
                    Также можно пользоваться поиском к примеру если ввести слово "господь",
                    в координатах можно увидеть сколько и где какое количество раз встречалось  слово.
                </p>
                <p>
                    Ниже пироги с долями частей речи, в дереве можно кликать если интерессно в какой области или книге.
                </p>
