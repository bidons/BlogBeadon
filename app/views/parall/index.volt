...
<hr>
    <div class="col-md-12">
        <li>
            <span>Параллельные координаты - способ визуализации статистических данных  в виде параллельно координат.
        ...
        <li>
            ...
            Анализ проводился на 100% совпадение. Что мы имеем:
             3854-тыс. старниц, 511163-тыс слов которые попали в анализ из 593991-тыс слов, уникальных слов(форм образований) - 23636.
        </li>
        <li>
            Координаты X (агрегаты):<p>
            Поскольку время создания каждой книги вызывает массу споров, то временные интервалы использовать не получится, поскольку
            статистической ценности в єтом очень мало, в качестве осей X у нас будет лимитированное количество по 5000 тысяч страниц
            (префиксы: old-старый завет, new - новый завет), в шкале количество найденых одинаковых слов и их количество, затемнение лининии это у нас
            плотность слов в категории, можно перемещатся по оси X и выделят интересующие фрагменты в разных плоскостях координат.
        </li>
        <li>
