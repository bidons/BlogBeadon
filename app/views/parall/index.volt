...
<div class="container">
    <div class="row">
        ...
        <div class="post-series-content">
            <ol>
                <li><a class="wrapper-blog" href="/parall/index"       title="Параллельные кординаты">Параллельные кординаты (введение)</a></li>
                <li><a class="wrapper-blog" {#href="/objectdb/part1" #}title="Практическое применение">Практическое применение</a></li>
                <li><a class="wrapper-blog" {#href="/objectdb/part2" #}title="GIN(ts-vector)">GIN(ts-vector)</a></li>
                <li><a class="wrapper-blog" {#href="/objectdb/part3" #}title="Прикольные фичи при работе с агрегатами">Прикольные фичи при работе с агрегатами</a></li>
            </ol>
        </div>
    </div>
<hr>
        <li>
            <span>Параллельные координаты - способ визуализации статистических данных  в виде параллельных координат.
                Где Y - категория, X - координаты расположеные параллельно друг другу.
                Будем анализировать сборник различных трудов и книг одним словом "Библию"
                используя части речи и формо-образующие слова.
            </span>
        </li>
        <li>
            Для анализа будем использовать базу русского языка в количестве 140000-тысч слов частей речи и их форм образований.
            Множество предварительно было нормализовано, тип библии - "старый завет, новый завет", категория: -"названия труда",
            являеться ли она канонической или нет.
            Анализ проводился на точное совпадение совпадение. Что мы имеем:
            37089-тыс. старниц, 511163-тыс слов которые попали в анализ из 593991-тыс слов, уникальных слов(форм образований) - 23636.
        </li>
        <li>
            Координаты X (агрегаты):<p>
            Поскольку время создания каждой книги вызывает массу споров единственное что известно: - "Старый завет до нашей эры, Новый завет после" то
            временные интервалы использовать не получится, поскольку статистической ценности в єтом очень мало, в качестве осей X у нас
            будет лимитированное количество по 5000 тысяч страниц
            (префиксы: old-старый завет, new - новый завет), в шкале количество найденых одинаковых слов и их количество, затемнение лининии
            плотность слов в категории, можно перемещатся по оси X выделяя мышкой интересующие фрагменты в разных плоскостях координат.
        </li>
        <li>
            Координаты Y (категории)<p>
            Категория части речи, можно включать отключать
        </li>
        <li>
            Множество DIM  (слова и их формы образования)<p>
                В качестве множества используем уникальные слова, можно пользоваться поиском (вывод первых пять, поиск полнотекстовый)
        </li>
        <li>
            Ниже пироги, топ 20 слов в категории по частоте использования, можно перемещатся по дереву (* - не каноническая),
...
<hr>
<div class="center-wrap">
    <h5>Части речи  (топ-20 по частоте) </h5>
</div>
<div class="row">
    <div class="col-md-5">
