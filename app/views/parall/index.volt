...
<div class="container">
    ...
    <li>
        Координаты X (агрегаты):<p>
            ...
            (old-старый завет, new - новый завет), в шкале количество найденых одинаковых слов и их
    ...
    <li>
        ...
        И вот єтим <a class="wrapper-blog" href="https://www.highcharts.com/" title="">https://www.highcharts.com/</a>;
    </li>
</div>
