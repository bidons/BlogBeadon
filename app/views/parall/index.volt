...
<div class="container">
    <li>
        В данном разделе предметной частью будут параллельные координаты. Рассматривать его стоит как механизм
        визулизации данных для определения узких мест при
        анализе различных преагрегированных состояний, одним словом, "параллельные координаты" в статье это способ
        визуализации статистических данных в виде параллельных координат
        где координаты в плоскости X,Y расположены параллельно друг другу. Будем анализировать книгу "Библию"
    ...
    <li>
        Для анализа будем использовать базу русского языка в количестве 140000 слов, частей речи и их форм
        образований.
...
<div class="container">
    ...
    <li>
        Координаты X (агрегаты):<p>
            ...
            временные интервалы использовать не получится да и статистической ценности в этом очень мало.
            ...
            затемнение линии плотность слов в координате, можно перемещатся по оси "X" выделяя мышкой интересующие
            фрагменты в разных плоскостях координат.
        </p>
    </li>
    <li>
        Координаты Y (категории):
        <p> Категорию "Части речи" можно включать отключать</p>
    </li>
    <li>
        Множество DIM (слова и их формообразования)<p>
...
<script>
    var dataBibleWordsPieSunBurst = [{"id": "10000", "name": "Библия", "parent": ""},
        ...
        {"id": "10005", "name": " ", "parent": "10000"},
        {"id": "10002", "name": "Новый завет", "parent": "10005"},
