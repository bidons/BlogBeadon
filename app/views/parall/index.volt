    ...
    <div class="col-md-12">
        <li>
            <span>Параллельные координаты - способ визуализации статистических данных  в виде параллельно координат.
                Где Y - категория, X - координаты расположеные паралельное друг другу.
                Будем аналировать сборник различных трудов и книг одним словом "Библию"
        ...
        <li>
            ...
            Поскольку время создания каждой книги вызывает массу споров, то временные интервалы использовать не получится, поскольку
                статистической ценности в єтом очень мало, в качестве осей X у нас будет лимитированное количество по 5000 тысяч страниц (префиксы: old-старый завет, new - новый завет),
                в шкале количество найденых одинаковых слов и их количество, затемнение лининии это у нас
