...
<div class="container">
    ...
    <li>
            Параллельные координаты - способ визуализации статистических данных  в виде параллельных координат
                где координаты в плоскости X,Y расположеные параллельно друг другу.
    ...
    <li>
        ...
        образований.
        Множество предварительно было нормализовано, тип библии - "старый завет, новый завет", категория: -"названия
        труда",
        являеться ли она канонической или нет.
        Анализ проводился на точное совпадение совпадение. Что мы имеем:
        37089-тыс. старниц, 511163-тыс слов которые попали в анализ из 593991-тыс слов, уникальных слов(форм
        образований) - 23636. </p>
    </li>
    <li>
