<div class="post-series-content">
        <ol>
            ...
            <li><a class="wrapper-blog" href="/objectdb/part2" title="Особенности работы  (планировщика запросов) PostgreSQL">Особенности работы  (планировщика запросов при работе с обвёртками) PostgreSQL</a></li>
            ...
            <li><a class="wrapper-blog" href="/objectdb/part5" title="Внутренности">Внутренности</a></li>
            <li><a class="wrapper-blog" href="/objectdb/part6" title="Создание конструкторов для поиска по DDL">Создание конструктора для поиска по DDL конструкциям</a></li>
        </ol>
</div>
