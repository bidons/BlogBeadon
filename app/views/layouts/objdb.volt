<div class="post-series-content">
        <ol>
            ...
            <li><a class="wrapper-blog" href="/objectdb/part2" title="Особенности работы  (планировщика запросов) PosgreSQL">Особенности работы  (планировщика запросов при работе с обвёртками) PosgreSQL</a></li>
            ...
            <li><a class="wrapper-blog" href="/objectdb/part5" title="Как это работает">Как это работает</a></li>
        </ol>
</div>
